...
return [
    ...
    'types' => [
        '1' => ['showitem' => 'hidden,--palette--;;1, title, gender, company, first_name, last_name, address, zip, city, email, phone, status, sent'],
    ],
    'palettes' => [
        '1' => ['showitem' => ''],
    ],
        ...
        'status' => [
            ...
            'config'=>[
                ...
                'items' => [
                    ...
                    ['LLL:EXT:simple_consent/Resources/Private/Language/locallang_db.xlf:tx_simpleconsent_domain_model_mail.status.3', '3'],
